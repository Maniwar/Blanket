...
| **[JUDGE.md](JUDGE.md)** | The reach-out judge — how a drafted proactive line is suppressed before the visitor sees it: the judge call contract, the six-defect criterion, veto/hold/fail-open semantics, control, observability, and cost. Diagram: [reach-out judge](docs/reach-out-judge.svg). |
